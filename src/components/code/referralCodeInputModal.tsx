...
interface ReferralCodeInputModalComponentProps {
  handleClose: () => void;
  open: boolean;
}
...
const ReferralCodeInputModal: React.FC<
  ReferralCodeInputModalComponentProps
> = ({ handleClose, open }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="h-full bg-black px-8 pt-[120px] pb-[120px]">
            <div className="flex flex-col justify-between items-center  gap-6 h-full text-[#67FE9B] text-2xl font-normal bg-[url('/images/modal-back.png')] bg-no-repeat bg-top bg-[length:200px_200px] md:bg-[length:300px_300px]">
